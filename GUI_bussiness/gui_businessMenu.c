...
//	lv_obj_set_click(menuBtnChoIcon_wifiConfig, 	false);
	...
	if(devStatusDispMethod_landscapeIf_get()){
		...
		lv_obj_animate(menuBtnChoIcon_linkageConfig, LV_ANIM_FLOAT_LEFT, 80,   0, NULL);
		lv_obj_animate(menuBtnChoIcon_wifiConfig,	 LV_ANIM_FLOAT_LEFT, 80,  50, NULL);
		lv_obj_animate(menuBtnChoIcon_setting,		 LV_ANIM_FLOAT_LEFT, 80, 100, NULL);
		lv_obj_animate(menuBtnChoIcon_other,		 LV_ANIM_FLOAT_LEFT, 80,  50, NULL);
	}
	else
	{
		lv_obj_animate(menuBtnChoIcon_linkageConfig, LV_ANIM_FLOAT_LEFT, 80,   0, NULL);
		lv_obj_animate(menuBtnChoIcon_wifiConfig,	 LV_ANIM_FLOAT_LEFT, 80,  50, NULL);
		lv_obj_animate(menuBtnChoIcon_setting,		 LV_ANIM_FLOAT_LEFT, 80,  50, NULL);
		lv_obj_animate(menuBtnChoIcon_other,		 LV_ANIM_FLOAT_LEFT, 80, 100, NULL);
	}

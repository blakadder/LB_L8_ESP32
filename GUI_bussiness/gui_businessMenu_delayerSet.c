		...
		if(objLabel_greenModeSet_titleSwStatusNormal == NULL){
			...
			switch(currentDev_typeGet()){
				...
				case devTypeDef_mulitSwThreeBit:{
					...
					lv_obj_align(objLabel_greenModeSet_titleSwStatusNormal, objLabel_greenModeSet_titleSwValTrig, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 60);
					...
					lv_obj_align(objSw_greenModeSet_statusNormal, objLabel_greenModeSet_titleSwStatusNormal, LV_ALIGN_OUT_BOTTOM_RIGHT, 0, 20);
			...
			switch(currentDev_typeGet()){
				...
				case devTypeDef_mulitSwTwoBit:{
					...
					lv_obj_align(objLabel_greenModeSet_titleRelaySel, objLine_greenModeSet_limit_C, LV_ALIGN_OUT_BOTTOM_LEFT, 3, 2);
					...
					lv_obj_align(cbGMode_relaySelect[0], objLabel_greenModeSet_titleRelaySel, LV_ALIGN_IN_BOTTOM_RIGHT, 45, 40);
...
//	lv_obj_set_top(objRoller_greenModeSet_second, true);
	...
	lv_obj_align(objSw_greenModeSet_swRunnigSet, objLabel_greenModeSet_titleSwValTrig, LV_ALIGN_OUT_BOTTOM_RIGHT, 60, 20);
	if(greenMode_timeCount){
